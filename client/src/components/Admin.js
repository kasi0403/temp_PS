      ...
      <div className="relative z-2">
        <div className="bg-white bg-opacity-80 p-8 rounded-lg shadow-md">
          ...
          <div className="flex justify-center mb-4">
            <button
              className={`mx-2 py-2 px-4 rounded ${registerType === 'patient' ? 'bg-blue-500 text-white' : 'bg-gray-300'}`}
              onClick={() => setRegisterType('patient')}
            >
              Register Patient
            </button>
            <button
              className={`mx-2 py-2 px-4 rounded ${registerType === 'care' ? 'bg-blue-500 text-white' : 'bg-gray-300'}`}
